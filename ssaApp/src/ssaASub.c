...
static long asFaultMsg_CA1300_7kW(aSubRecord *prec){
/*------------------------------------------------------------------------------
Takes an integer error code as input, and displays a string message as output.
- Since we're using a strinout record for the output, output messages should be 
    < 40 chars; otherwise we should use a waveform record.
 *----------------------------------------------------------------------------*/
    ...
    else if (*errCode == 116) errMsg = "FA1 3-4 REF";
    else if (*errCode == 121) errMsg = "FA1 1 +45VDC";
    else if (*errCode == 122) errMsg = "FA1 2 +45VDC";
    else if (*errCode == 123) errMsg = "FA1 3 +45VDC";
    else if (*errCode == 124) errMsg = "FA1 4 +45VDC";
    ...
    else if (*errCode == 211) errMsg = "FA2 1-2 FWD";
    else if (*errCode == 212) errMsg = "FA2 3-4 FWD";
    else if (*errCode == 215) errMsg = "FA2 1-2 REF";
    else if (*errCode == 216) errMsg = "FA2 3-4 REF";
    else if (*errCode == 221) errMsg = "FA2 1 +45VDC";
    else if (*errCode == 222) errMsg = "FA2 2 +45VDC";
    else if (*errCode == 223) errMsg = "FA2 3 +45VDC";
    else if (*errCode == 224) errMsg = "FA2 4 +45VDC";
    ...
    else if (*errCode == 311) errMsg = "FA3 1-2 FWD";
    else if (*errCode == 312) errMsg = "FA3 3-4 FWD";
    else if (*errCode == 315) errMsg = "FA3 1-2 REF";
    else if (*errCode == 316) errMsg = "FA3 3-4 REF";
    else if (*errCode == 321) errMsg = "FA3 1 +45VDC";
    else if (*errCode == 322) errMsg = "FA3 2 +45VDC";
    else if (*errCode == 323) errMsg = "FA3 3 +45VDC";
    else if (*errCode == 324) errMsg = "FA3 4 +45VDC";
...
//    else if (*errCode == 525) errMsg = "Ext. Fault 1,2,3,4 24V Permit Line";
    ...
    else if (*errCode == 597) errMsg = "FA5 Sub CPU/Proc Fault";
    ...
    else if (*errCode == 602) errMsg = "FA4 Current 2";
    else if (*errCode == 603) errMsg = "FA4 Current 3";
    else if (*errCode == 604) errMsg = "FA4 Current 4";
    else if (*errCode == 611) errMsg = "FA4 1-2 FWD";
    else if (*errCode == 612) errMsg = "FA4 3-4 FWD";
    else if (*errCode == 615) errMsg = "FA4 1-2 REF";
    else if (*errCode == 616) errMsg = "FA4 3-4 REF";
    else if (*errCode == 621) errMsg = "FA4 1 +45VDC";
    else if (*errCode == 622) errMsg = "FA4 2 +45VDC";
    else if (*errCode == 623) errMsg = "FA4 3 +45VDC";
    else if (*errCode == 624) errMsg = "FA4 4 +45VDC";
    ...
    else if (*errCode == 701) errMsg = "FA5 Current 1";
    else if (*errCode == 702) errMsg = "FA5 Current 2";
    else if (*errCode == 703) errMsg = "FA5 Current 3";
    else if (*errCode == 704) errMsg = "FA5 Current 4";
    else if (*errCode == 711) errMsg = "FA5 1-2 FWD";
    else if (*errCode == 712) errMsg = "FA5 3-4 FWD";
    else if (*errCode == 715) errMsg = "FA5 1-2 REF";
    else if (*errCode == 716) errMsg = "FA5 3-4 REF";
    else if (*errCode == 721) errMsg = "FA5 1 +45VDC";
    else if (*errCode == 722) errMsg = "FA5 2 +45VDC";
    else if (*errCode == 723) errMsg = "FA5 3 +45VDC";
    else if (*errCode == 724) errMsg = "FA5 4 +45VDC";
