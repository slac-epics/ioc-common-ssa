...
iocshLoad("$(TOP)/iocBoot/common/startup.RK_CA1300.iocsh", "PORT=BUN_SSA1,P=ACCL:GUNB:455:SSA1:,IP=ssa-gunb-455-1")

# SSA2: ACCL:GUNB:455:SSA2
iocshLoad("$(TOP)/iocBoot/common/startup.RK_CA1300.iocsh", "PORT=BUN_SSA2,P=ACCL:GUNB:455:SSA2:,IP=ssa-gunb-455-2")

# SSA3: ACCL:GUNB:455:SSA3
iocshLoad("$(TOP)/iocBoot/common/startup.RK_CA1300.iocsh", "PORT=BUN_SSA3,P=ACCL:GUNB:455:SSA3:,IP=ssa-gunb-455-3")

# SSA4: ACCL:GUNB:455:SSA4
iocshLoad("$(TOP)/iocBoot/common/startup.RK_CA1300.iocsh", "PORT=BUN_SSA4,P=ACCL:GUNB:455:SSA4:,IP=ssa-gunb-455-4")
