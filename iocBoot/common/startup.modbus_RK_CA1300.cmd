...
# Default data type: unsigned integer
drvModbusAsynConfigure("$(P)_inw2", "$(P)", 0, 3, 120, 8, 0, 5000, "RK")
...
# Default data type: unsigned integer
drvModbusAsynConfigure("$(P)_outw1", "$(P)", 0, 6, 1, 6, 0, 100, "RK")
...
# Default data type: unsigned integer
drvModbusAsynConfigure("$(P)_outw2", "$(P)", 0, 6, 112, 5, 0, 100, "RK")
